 ...
 * @author s0cr4t3sd
 */
public class Z_Juego extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Z_VentanaAddJugadores ventanaJuego = new Z_VentanaAddJugadores(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Z_Juego.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
